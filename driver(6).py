...
def main():
  image_path = str(input('Enter image file path'))
  if not os.path.isfile(image_path):
    raise ValueError('Image file path is broken. Check again!')
  ...
  print("These are the detected text that you have to enter in json with translation \n")
  for texts in recognised_texts_fe:
    
    print(texts)

  json_path = input("enter json path here")
  if not os.path.isfile(json_path):
    raise ValueError('JSON file path is broken, check again.')
